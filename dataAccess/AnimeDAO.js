...
class AnimeDAO {
  ...
  static async crearAnime(animeData) {
    try {
      ...
      throw new DataAccessError(
        "Se ha producido un problema al crear el anime"
      );
    }
  }
  ...
  static async obtenerAnimePorId(id) {
    try {
      ...
      throw new NoDataFoundError(
        "Se ha producido un problema al obtener el anime"
      );
    }
  }
  ...
  static async actualizarAnime(id, animeData) {
    try {
      ...
      throw new NoDataFoundError(
        "Se ha producido un problema al actualizar el anime"
      );
    }
  }
  ...
  static async eliminarAnime(id) {
    try {
      ...
      throw new NoDataFoundError(
        "Se ha producido un problema al eliminar el anime"
      );
    }
  }

  static async obtenerAnimes() {
    try {
      return await Anime.find();
    } catch (error) {
      throw new NoDataFoundError(
        "Se ha producido un problema al obtener todos los animes"
      );
    }
  }
}
